                        ...
                        <ul class="vertical-menu">
                            ...
                            <li class="{{ Nav::isRoute('admin.index') }}">
                                <a class="nav-link" href="{{route('admin.index')}}">
                                    <i class="fa fa-pied-piper text-secondary"></i>
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i class="fa fa-user-plus text-secondary"></i><span>{{ __('Users') }}</span><i
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="fa fa-user-circle-o text-secondary"></i>
                                        <span>{{ __('adminstaticword.Instructors') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="fa fa-book text-secondary"></i><span>{{ __('adminstaticword.Course') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                                    <!-- Category start  -->
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i class="fa fa-hourglass text-secondary"></i>
                            ...
                            <li><a href="{{url('institute')}}"><i
                                        class="fa fa-indent text-secondary"></i>
                                        <span>{{ __('Institute') }}</span></a>
                            </li>
                            ...
                            <li class="{{ Nav::isResource('coupon') }}"><a href="{{url('coupon')}}"><i
                                        class="fa fa-gift text-secondary"></i>
                                        <span>{{ __('adminstaticword.Coupon') }}</span></a>
                            </li>
                            <li class="{{ Nav::isRoute('follower.view') }}"><a href="{{route('follower.view')}}"><i
                                        class="fa fa-universal-access text-secondary"></i><span>{{ __('Followers') }}</span></a>
                            </li>
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="fa fa-usd text-secondary"></i><span>{{ __('adminstaticword.Affiliate&Wallet') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                            ...
                            <li class="{{ Nav::isRoute('onesignal.settings') }}"><a
                                    href="{{route('onesignal.settings')}}"><i
                                        class="fa fa-paper-plane text-secondary"></i>
                                        <span>{{ __('adminstaticword.PushNotification') }}</span></a>
                            </li>



                            <li class="{{ Nav::isResource('admin/flash-sales') }}"><a
                                    href="{{url('admin/flash-sales')}}">
                                    <i
                                        class="fa fa-bullhorn text-secondary"></i>
                            ...
                            <li class="{{ Nav::isResource('attandance') }}"><a href="{{url('attandance')}}"><i
                                        ...
                                        <span>{{ __('adminstaticword.Attandance') }}</span></a>
                            </li>
                            @endif
                            ...
                            <li class="{{ Nav::isResource('order') }}"><a href="{{url('order')}}"><i
                                        class="fa fa-cart-plus text-secondary"></i><span>{{ __('adminstaticword.Order') }}</span></a>
                            </li>
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="fa fa-file-text text-secondary"></i><span>{{ __('adminstaticword.Report') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                            ...
                            <li class="{{ Nav::isRoute('about.page') }}">
                                <a href="{{route('about.page')}}">
                                    ...
                                    </i>{{ __('adminstaticword.About') }}</a>
                            </li>
                            <!-- faq start  -->
                            <li class="{{ Nav::isResource('faq') }} {{ Nav::isResource('faqinstructor') }}">
                                <a href="javaScript:void();">
                                    <i
                                        class="fa fa-question-circle text-secondary"></i><span>{{ __('adminstaticword.Faq') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                            ...
                            <li class="{{ Nav::isRoute('certificate.index') }}"><a
                                    ...
                                    <i class="fa fa-certificate text-secondary"></i><span>{{ __('CertificateVerification') }}</span>
                                </a></li>
                            <!-- contact us start -->
                            <li class="{{ Nav::isResource('usermessage') }}"><a href="{{url('usermessage')}}"><i
                                        class="fa fa-volume-control-phone text-secondary"></i><span>{{ __('adminstaticword.ContactUs') }}</span>
                                </a>
                            </li>
                            ...
                            <li class="{{ Nav::isRoute('currency.index') }}"><a href="{{route('currency.index')}}"><i
                                        class="fa fa-money text-secondary"></i><span>{{ __('adminstaticword.Currency') }}</span></a>
                            </li>
                            <!-- front setting start  -->
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="fa fa-desktop text-secondary"></i><span>{{ __('adminstaticword.FrontSetting') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                            ...
                            <li class=" {{ Nav::isRoute('api.setApiView') }} ">
                                <a href="javaScript:void();">
                                    <i
                                        class="fa fa-dollar text-secondary"></i><span>{{ __('Payment Setting') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="fa fa-play-circle text-secondary"></i><span>{{ __('adminstaticword.PlayerSettings') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="fa fa-question-circle text-secondary"></i><span>{{ __('adminstaticword.Help&Support') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
